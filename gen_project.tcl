...
set _xil_proj_name_ "spdif_proj"
...
set orig_proj_dir "[file normalize "$origin_dir/spdif_proj"]"

# Create project
create_project ${_xil_proj_name_} ./${_xil_proj_name_} -part xc7a35tcsg325-1
...
set files [list \
 [file normalize "${origin_dir}/spdif_tx.v"] \
]
...
set obj [get_filesets sources_1]
set_property -name "top" -value "spdif_transmit" -objects $obj
...
set obj [get_filesets constrs_1]
set_property -name "target_part" -value "xc7a35tcsg325-1" -objects $obj
...
set files [list \
 [file normalize "${origin_dir}/spdif_tx_testbench.v"] \
 [file normalize "${origin_dir}/spdif_tx_testbench_behav.wcfg"] \
]
add_files -norecurse -fileset $obj $files
...
set obj [get_filesets sim_1]
set_property -name "top" -value "spdif_tx_testbench" -objects $obj
...
if {[string equal [get_runs -quiet synth_1] ""]} {
    create_run -name synth_1 -part xc7a35tcsg325-1 -flow {Vivado Synthesis 2018} -strategy "Vivado Synthesis Defaults" -report_strategy {No Reports} -constrset constrs_1
} else {
...
if {[string equal [get_runs -quiet impl_1] ""]} {
    create_run -name impl_1 -part xc7a35tcsg325-1 -flow {Vivado Implementation 2018} -strategy "Vivado Implementation Defaults" -report_strategy {No Reports} -constrset constrs_1 -parent_run synth_1
} else {
